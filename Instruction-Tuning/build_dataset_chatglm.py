...
def build_instruction_dataset(data_path: Union[List[str],str],
    ...
    def tokenization(examples):
        ...
        for instruction, input, output in zip(examples['instruction'],examples['input'],examples['output']):
            ...
            # for chatglm, cannot add eos token here, for it does not provide special token
            target = f"{output}"
        ...
        tokenized_targets['input_ids'] = [token_id + [tokenizer.eos_token_id] for token_id in tokenized_targets['input_ids']]
